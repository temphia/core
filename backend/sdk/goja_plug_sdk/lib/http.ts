export declare function _http1(method: string, url: string, headers: object, body: string): [number, object, string];
...
export class Request {
    ...
    get = () => {
        const [status, header, body] = _http1("GET", this._url, this._headers, null)
