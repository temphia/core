...
export declare function _log_lazy(message: string[]): void
export declare function _sleep(time: number): void
export declare function _get_self_file_as_str(file: string): [string, string]
