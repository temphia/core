export declare function _pkv_set(tx: number, key: string, value: string, opts?: any): string
export declare function _pkv_update(tx: number, key: string, value: string, opts?: any): string
export declare function _pkv_get(tx: number, key: string): [PlugValue, string];
export declare function _pkv_query(tx: number, opts: PlugQuery): [PlugValue[], string];
export declare function _pkv_del(tx: number, key: string): string;
export declare function _pkv_batch_del(tx: number, keys: string[]): string;
export declare function _pkv_new_txn(): [number, string];
export declare function _pkv_rollback(tx: number): string;
export declare function _pkv_commit(tx: number): string;
