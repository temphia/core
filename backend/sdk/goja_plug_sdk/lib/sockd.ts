export declare function _sd_send_direct(room: string, connIds: string[], value: string): string
export declare function _sd_send_broadcast(room: string, value: string): string
export declare function _sd_send_tagged(room: string, tags: string[], value: string, ignore?: string[]): string
export declare function _sd_add_to_room(room: string, conn: string, tags: string[]): string
export declare function _sd_kick_from_room(room: string, conn: string): string
export declare function _sd_list_room_conns(room: string): [object, string]
export declare function _sd_bann_conn(conn: string): string
