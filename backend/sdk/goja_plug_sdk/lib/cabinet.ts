export declare function _cab_add_file(folder: string, file: string): string
export declare function _cab_list_folder(folder: string, file: string): [string[], string]
export declare function _cab_get_file(folder: string, file: string): [ArrayBuffer, string]
export declare function _cab_get_file_str(folder: string, file: string): [string, string]
export declare function _cab_del_file(folder: string, file: string): string
export declare function _cab_generate_ticket(folder: string, opts: any): [string, string]
