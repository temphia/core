...
type DynSource interface {
	NewGroup(model *entities.NewTableGroup) error
	...
	AddTable(gslug string, model *entities.NewTable) error
	...
	AddColumn(gslug, tslug string, model *entities.NewColumn) error
...
type DynDB interface {
	NewGroup(tenantId string, model *entities.NewTableGroup) error
	...
	AddTable(tenantId, gslug string, model *entities.NewTable) error
	...
	AddColumn(tenantId, gslug, tslug string, model *entities.NewColumn) error
...
func ExtractColumns(m *entities.NewTable, tenantId, gslug string) []*entities.Column {
