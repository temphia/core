...
func (d *DynDDL) NewGroup(tenantId string, model *entities.NewTableGroup) error {
...
func (d *DynDDL) newGroupRef(tenantId string, model *entities.NewTableGroup) (err error) {
