...
import (
	...
	"github.com/temphia/temphia/backend/server/store/upper/dyndb/dynddl"
...
func (d *DynDB) AddTable(tenantId, gslug string, model *entities.NewTable) error {
	ddl := d.ddlSess()
...
func (d *DynDB) AddColumn(tenantId, gslug, tslug string, model *entities.NewColumn) error {
	ddl := d.ddlSess()
...
func (d *DynDB) NewGroup(tenantId string, model *entities.NewTableGroup) error {
